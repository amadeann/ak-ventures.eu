...
<div class="flex justify-center bg-blue-200 text-gray-600">
    <div class="container max-w-3xl flex flex-col items-center mx-auto py-20 px-4 text-center">
        ...
        <p class="text-xl mb-20">Even though we share very similar backgrounds, we have completely different personalities, skills, talents, and areas of expertise complementig each other to run strong businesses and lead globally distributed teams.</p>
